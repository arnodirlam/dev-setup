...
brew "asitop"                # Perf monitoring CLI tool for Apple Silicon
...
brew "libarchive"            # Multi-format archive and compression library
...
brew "hcloud"                # Command-line interface for Hetzner Cloud
brew "libyaml"               # YAML Parser
brew "hf"                    # Client library for huggingface.co hub
...
brew "libbluray"             # Blu-Ray disc playback library for media players like VLC
...
brew "unpaper"               # Post-processing for scanned/photocopied books
brew "ocrmypdf"              # Adds an OCR text layer to scanned PDF files
brew "ollama", restart_service: :changed # Create, run, and share large language models (LLMs)
brew "openai-whisper"        # General-purpose speech recognition model
...
brew "postgresql@17", restart_service: :changed # Object-relational database system
brew "ripgrep"               # Search tool like grep and The Silver Searcher
brew "rust"                  # Safe, concurrent, practical language
brew "sshpass"               # Non-interactive SSH password auth
brew "tesseract-lang"        # Enables extra languages support for Tesseract
brew "testdisk"              # Powerful free data recovery utility
...
brew "terror/tap/just-lsp", trusted: true # Language server for just
...
cask "avidemux"              # Video editor
cask "blackhole-2ch"         # Virtual Audio Driver
cask "blender"               # 3D creation suite
cask "bluesnooze"            # Prevents your sleeping computer from connecting to Bluetooth accessories
cask "canva"                 # Design tool
cask "chatgpt"               # OpenAI's official ChatGPT desktop app
cask "chatgpt-classic"       # OpenAI's previous ChatGPT desktop app
...
cask "disk-drill"            # Data recovery software
cask "doll"                  # Utility to show apps badges from the dock in the menu bar
...
cask "flux-app"              # Screen colour temperature controller
...
cask "hstracker"             # Deck tracker and deck manager for Hearthstone
...
cask "macsvg"                # App for designing HTML5 Scalable Vector Graphics
...
cask "phoenix-slides"        # Full-screen slideshow program
